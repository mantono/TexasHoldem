...
Alla fyra har tillämpat testdriven utveckling under större delen av projektets gång.
...
Här följer 4 olika exempel på testfall som skrivits av alla personer i projektet och det som togs fram med hjälp av testfallen.
\clearpage
Elliot : PotTest\\
\begin{lstlisting}
@Test
...
Vi har arbetat med testdriven under större del av projektets gång vilket har gett oss en mängd erfarenheter av hur bra/dåligt det kan fungera.
...
så ger testfallen mycket mer information om exakt hur metoden ska bete sig och vilket resultat som förväntas.
...
Det krävs god disciplin för att inte slarva och börja övergå i ad-hoc-testning, speciellt under tidspress, något som vi kanske inte kan säga att vi alltid lyckats med. Det är inte heller alla gånger som vi varit helt överens om hur vi ska prioritera testbarhet kontra inkapsling.
