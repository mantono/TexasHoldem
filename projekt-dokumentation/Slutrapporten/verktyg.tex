...
Vi skrev ett profilertest där ett antal huvudmetoder loopas igenom ett flertal gånger så att processen håller på ett tag så att vi kunde se hur mycket våra metoder påverkar datorns prestanda. Vi testade både profiler verktyg för NetBeans och Eclipse innan vi bestämde oss för att använda Eclipse JVM Monitor.
