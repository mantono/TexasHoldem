...
Om vi hade haft råd att äta pizza oftare hade det nog varit mer än ett. Pizza metric index är kanske inte ett mått som är helt applicerbart i en studentmiljö. Många delar av projektet har tagit längre tid än man förväntat sig, och vi är nog alla glada att vi började så pass tidigt som vi gjorde.
